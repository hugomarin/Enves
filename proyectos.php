...
-->
		...
		<body>
				   ...
				   <div id="gallery_six"><a href="index.php#anchor_portafolio_home2">enves</a></div>
						<div id="menu_items_container">
							<ul>
								...
								<li><a href="proyectos.php" class="main_menu_active">PROYECTOS</a></li>
			...
			<div class="banner_wrapper2" id="first">
				<ul class="bxslider">
					<li>
						<img class="banner_small" src="img/banners/proyectos/IMG_9864.jpg" height="733" alt="" />
					</li>
					<li>
						<img class="banner_small" src="img/banners/proyectos/IMG_5480.jpg" height="733" alt="" />
					</li>
					<li>
						<img class="banner_small" src="img/banners/proyectos/IMG_3639.jpg" alt="" />
					</li>
					<li>
						<img class="banner_small" src="img/banners/proyectos/IMG_3248.jpg" height="733" alt="" />
					</li>
					<li>
						<img class="banner_small" src="img/banners/proyectos/IMG_3668.jpg" height="733" alt="" />
					</li>
				</ul>
			</div>
			<div class="banner3 height_fixed">
				<div class="row banner3_content">
					<div class="twelve columns">
						<p class="banner_p3">PROYECTOS</p>
					</div>
					<div class="twelve columns ">
						<p class="banner_p_proyectos">Diseñamos y desarrollamos
							<br>proyectos y estrategias que generen
							<span class="banner_p2"></span>
							<span class="banner_p2">
								<br>valor socio-ambiental.</span>
						</p>
					</div>
					<div class="">
						<div class="twelve columns  button_center2_proyectos ">
							<a href="#anchor_portafolio_home" class="button6">VER PROYECTOS</a>
						</div>
					...
					<div class="four column">
						...
						<div class="dark_text">
							<p class="third_p">Creamos proyectos para el
								<strong>
									<span class="gold">eficiente aprovechamiento y recuperación de residuos sólidos</span>
								</strong>post industriales, diseñamos productos de acuerdo a sus necesidades, fabricamos en red con comunidades de población vulnerable o capacitamos sus comunidades de interés.
							</p>
						</div>
					</div>
					<div class="four column">
						...
						<div class="dark_text">
							<p class="third_p">Creemos que las buenas acciones deben estar
								<strong>
									<span class="gold">bien comunicadas</span>
								</strong>, por eso somos expertos en diseñar herramientas para
								<strong>sensibilizar, transmitir y comunicar</strong>, dentro y fuera de su empresa u organización todo lo relacionado con su compromiso hacia la sostenibilidad.</p>
						</div>
					</div>
					<div class="four column" style="float:left">
						<div class="darkbg3"></div>
						<div class="dark_text">
							<p class="third_p">Construimos
								<strong>
									<span class="gold">estrategias</span>
								</strong>para el aprovechamiento de sus
								<strong>residuos post-industriales.</strong>
							</p>
						</div>
					</div>
				</div>
					...
					<div class="row ">
						...
						<div class="four columns">
							<div class="element_gallery_container">
								...
								<div id="images"></div>
								<span class="subtitle3">RECUPERACIÓN RESIDUOS</span>
								<br>
								<span class="subtitle4">HUNTER DOUGLAS</span>
					...
					<div class="row ">
						...
						<div class="four columns">
							<div class="element_gallery_container">
								...
								<div id="images"></div>
								<span class="subtitle3">REUTILIZACIÓN CARPAS CAMIONES BAVARIA</span>
								<br>
						...
						<div class="four columns">
							<div class="element_gallery_container">
								<a id="loadimages4" class="example-image-link " href="" data-lightbox="muñeco" title="Trabajo con iniciativas productivas de Barrancabermeja.">
									<img src="img/thumbnails/04_ecopetrol_coopcrear/thumbnail.jpg" alt="foto1" />
								</a>
								<div id="images"></div>
								<span class="subtitle3">MUÑECOS INSTITUCIONALES</span>
								<br>
								<span class="subtitle4">ECOPETROL</span>
					...
					<div class="row ">
						<div class="four columns">
							<div class="element_gallery_container">
								...
								<span class="subtitle3">MOBILIARIO CON LLANTAS RECUPERADAS ARTBO</span>
								<br>
								<span class="subtitle4">ENVÉS</span>
								<p class="secondary_p">El pabellón infatil de Artbo 2012, requería para el mobiliario algo diferente, funcional y que tuviera un mensaje para los asistentes, Enves diseñó unas coloridas sillas hechas con llantas reutilizadas y puffs hechos con lona impermeable rellenos de picadillo de icopor recuperado.</p>
							</div>
						</div>
					</div>
					</div>
